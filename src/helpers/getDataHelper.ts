...
export async function getOfferData(): Promise<OfferDataModel[] | null> {
	try {
		const res = await fetch('https://flora-retro.pl/api/offer');
...
export async function getOpinionsData(): Promise<OpinionsDataModel[] | null> {
	try {
		const res = await fetch('https://flora-retro.pl/api/opinions');
		if (!res.ok) return null;
		const data = await res.json();
		return data;
	} catch (error) {
...
export async function getBlogArticlesData(): Promise<SlideDataBoxModel[] | null> {
	try {
		const res = await fetch('https://flora-retro.pl/api/articles');
		if (!res.ok) return null;
		const data = await res.json();
		return data;
	} catch (error) {
...
export async function getRentCarImagesData(): Promise<SlideDataBoxModel[] | null> {
	try {
		const res = await fetch('https://flora-retro.pl/api/images');
		if (!res.ok) return null;
		const data = await res.json();
		return data;
	} catch (error) {
